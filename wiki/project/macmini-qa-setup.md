---
type: project
tags: [qa, testing, macmini, playwright, setup]
created: 2026-04-12
updated: 2026-04-12
confidence: high
source_migration: docs/testing/macmini/setup-instructions.md
---
...
The repo contains:
- `[[project/testing-framework]]` — feature inventory, test coverage, and gaps
- `docs/testing/macmini/testing-checklist.md` — step-by-step visual testing instructions
- `wiki/project/testing-guides/` — detailed manual test guides (10 guides, 220+ test cases)
