...
|--------|------|----------|-------------|--------|--------|----|-------|
| T-002 | 2026-04-06 | new-feature | Landlord Onboarding & Decision Profile — risk appetite, delegation mode, auto-approve thresholds, vendor preferences | feature/T-002-landlord-onboarding-decision-profile | open | — | Foundational for Phase 2 automation |
