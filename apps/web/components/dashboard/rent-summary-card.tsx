...
export function RentSummaryCard({ rentStatus, onRecordPayment }: RentSummaryCardProps) {
  ...
  return (
    <Card>
      ...
      <CardContent className="px-4 pb-4 space-y-2">
        ...
        {onRecordPayment && (
          <Button size="sm" variant="outline" className="mt-1 w-full" onClick={onRecordPayment}>
            Record Payment
          </Button>
        )}
      </CardContent>
